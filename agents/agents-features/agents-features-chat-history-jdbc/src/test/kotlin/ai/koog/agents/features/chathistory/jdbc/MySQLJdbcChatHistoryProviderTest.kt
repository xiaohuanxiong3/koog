...
class MySQLJdbcChatHistoryProviderTest : AbstractJdbcChatHistoryProviderTest() {
    ...
    override fun provider(tableName: String, ttlSeconds: Long?): MySQLJdbcChatHistoryProvider {
